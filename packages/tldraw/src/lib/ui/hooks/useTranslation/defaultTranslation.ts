...
export const DEFAULT_TRANSLATION = {
	...
	'action.find-on-canvas': 'Find on canvas',
	...
	'find-on-canvas.title': 'Find on canvas',
	'find-on-canvas.placeholder': 'Find on canvas',
	'find-on-canvas.matches': 'Matches',
	'find-on-canvas.previous': 'Previous match',
	'find-on-canvas.next': 'Next match',
	'find-on-canvas.close': 'Close find',
	'find-on-canvas.position': '{index} of {total}',
	'find-on-canvas.idle': 'Search shape text, notes, bookmarks, and page names.',
	'find-on-canvas.no-results': 'No shapes contain ‘{query}’.',
	'find-on-canvas.opened':
		'Find on canvas. Type to search shape text, notes, bookmarks, and page names.',
	'find-on-canvas.result': '{text}, {kind}, on page {page}.',
	'find-on-canvas.page-result': 'Go to page {page}.',
	'find-on-canvas.switched-page': 'Switched to page {page}.',
	'find-on-canvas.kind.page': 'Page',
	'find-on-canvas.hint.move': 'move',
	'find-on-canvas.hint.jump': 'jump',
	'find-on-canvas.hint.close': 'close',
	'toast.close': 'Close',
