...
export type TLUiTranslationKey =
	...
	| 'find-on-canvas.title'
	| 'find-on-canvas.placeholder'
	| 'find-on-canvas.matches'
	| 'find-on-canvas.previous'
	| 'find-on-canvas.next'
	| 'find-on-canvas.close'
	| 'find-on-canvas.position'
	| 'find-on-canvas.idle'
	| 'find-on-canvas.no-results'
	| 'find-on-canvas.opened'
	| 'find-on-canvas.result'
	| 'find-on-canvas.page-result'
	| 'find-on-canvas.switched-page'
	| 'find-on-canvas.kind.page'
	| 'find-on-canvas.hint.move'
	| 'find-on-canvas.hint.jump'
	| 'find-on-canvas.hint.close'
	| 'toast.close'
	| 'toast.success'
	| 'toast.error'
	| 'toast.info'
